...
from trackers.utils import get_axis_aligned_bbox
...
def main(et_path0, et_path1, et_path2):
    parser = argparse.ArgumentParser(description='siamet tracking')
    ...
    dataset_root = '/media/xx/新加卷2/'+args.dataset+'/sequences'
    #  tracker
    ...
    gpu_id = 0
    tracker = SiamETTracker(model_path, et_path1, gpu_id, step, et_path0, et_path2)
    # create dataset
...
if __name__ == '__main__':
     ...
     model_path='../models/OTB100/ET_model.pth.tar'
     ...
     # print(et_path1)
     # print(et_path2)
     main(et_path0, et_path1, et_path2)
     tracker_dir = '../result//'
